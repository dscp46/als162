...
![ALS162 Waveform](als162_waveform.png)
  ...
  - The 250~900ms slot contains a 3-state signal, which content isn't currently defined. One notable characteristic, however, is the number of `+π rad` and `-π rad` is balanced, to keep the long term phase average centered around zero radian.
